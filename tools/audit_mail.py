...
def audit(rom, reference_directory):
    ...
    result['gyroid_message'] = gyroid_evidence(rom)
    ...
    result['references']['set_message_mail']['status'] = (
        'Gyroid/demo message setter: neither identified caller passes stored Mail_c text')
    return result
