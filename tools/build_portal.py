...
TARGET_SHA = '64335524d2159b5715a73f331c741e11ea12b9a98c67a5903905e406765ddb01'
...
def main():
    ...
    parser.add_argument('--target', type=Path, default=ROOT/'build/v2-keyboard-polish-10-final/Animal Forest English V2.z64')
    ...
    if sha256(target) != TARGET_SHA or struct.unpack_from('>2I', target, 0x10) != n64_checksum(target):
        raise ValueError('Expected the checksummed V2-10 polished N64 keyboard cartridge')
    ...
    for name in WEB_FILES + NOTICE_FILES:
        shutil.copyfile(ROOT/'web'/name, site/name)
    manifest = {'format': 1, 'label': 'V2 · N64 keyboard edition', 'build': 'V2-10',
