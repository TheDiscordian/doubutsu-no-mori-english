...
static const struct af_v2_icon af_v2_icons[] = {
    ...
    {0xCE48,0xC648,0,0x2000,32,64,104,202,9,18,0,0},
    ...
    {0x6348,0x6248,0,0x8,16,16,263,119,10,10,0,1},
    {0x6148,0x6048,0,0x2,16,16,253,129,10,10,0,1},
    {0x5F48,0x5E48,0,0x1,16,16,273,129,10,10,0,1},
    {0x6548,0x6448,0,0x4,16,16,263,139,10,10,0,1},
};
...
static void af_v2_labels(void *graph, void *game, float dx, float dy) {
    static const struct {const char *word; unsigned short x,y;} labels[]={
        {"Case",69,116},{"Page",119,205},{"Move",23,200},{"Cursor",252,153},
        {"Type",260,181},{"Del",272,203},{"Space",200,117},{"Done",187,205}
    };
    static const struct {
