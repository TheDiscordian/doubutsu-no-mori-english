...
static const struct af_v2_icon af_v2_icons[] = {
    ...
    {0xCE48,0xC648,0,0x2000,32,64,104,206,9,18,0,0},
    {0x14648,0x16448,0x14E48,0x8000,32,32,242,181,14,14,0,0},
    {0x13E48,0x15C48,0x14E48,0x4000,32,32,254,203,14,14,0,0},
    {0x8E48,0x8648,0,0x10,64,32,180,118,18,9,0,0},
    {0x13648,0x15448,0x14E48,0x1000,32,32,170,208,14,14,0,0},
    {0x6348,0x6248,0,0x8,16,16,255,119,10,10,0,1},
    {0x6148,0x6048,0,0x2,16,16,245,129,10,10,0,1},
    {0x5F48,0x5E48,0,0x1,16,16,265,129,10,10,0,1},
    {0x6548,0x6448,0,0x4,16,16,255,139,10,10,0,1},
};
...
static void af_v2_labels(void *graph, void *game, float dx, float dy) {
    static const struct {const char *word; unsigned short x,y;} labels[]={
        {"Case",69,116},{"Page",119,209},{"Move",23,200},{"Cursor",244,153},
        {"Type",260,181},{"Del",272,203},{"Space",200,117},{"Done",187,209}
    };
    static const struct {
        ...
        {0x20,107,115,0,"L"},{0x10,371,115,0,"R"},
        {0x8000,493,181,1,"A"},{0x4000,518,203,1,"B"}
    };
