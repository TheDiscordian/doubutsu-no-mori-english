...
that fit the current rules. Its report in `build/pak-festivals-identity-review/`
still identifies 1,466 without visible same-ID English, 102 requiring fields,
36 with control differences, eight overflows, 36 native non-static records,
...
`build/pak-festivals-expression-review/queue.jsonl`, generated by
...
Current main-bank coverage is 9,685 candidates; 2,067 records remain without
candidates, including 1,136 containing Japanese static text. The reference
rejection queue contains 1,673 unconfirmed identities, 320 control-signature
