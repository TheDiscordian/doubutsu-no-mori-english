...
that fit the current rules. Its report in `build/native-context-identity-review/`
still identifies 1,512 without visible same-ID English, 102 requiring fields,
38 with control differences, eight overflows, 36 native non-static records,
...
`build/community-conversations-review/queue.jsonl`, generated by
...
Current main-bank coverage is 9,635 candidates; 2,117 records remain without
candidates, including 1,186 containing Japanese static text. The reference
rejection queue contains 1,721 unconfirmed identities, 322 control-signature
