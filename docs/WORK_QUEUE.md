...
that fit the current rules. Its report in `build/startup-pak-identity-review/`
still identifies 1,461 without visible same-ID English, 49 requiring fields,
31 with control differences, seven overflows, 36 native non-static records,
...
Continue the twelve comparisons in
`build/startup-pak-expression-review/queue.jsonl`, generated by
`tools/resident_review_queue.py` from the current candidate file: Rover `0467`,
Gracie `0723`, Booker `0785`, Redd `0789`, Jingle `07AA`,
sleeping resident `0D3F`, title-menu `14A2/14D9`, and Gulliver
...
recovery, warning rendering, and final review remain required. Continue missing
startup greetings/preparation and menu variants, including `14A2/14D9`, alongside
broader native-topic translation; do not repeat the unchanged Pak loader batch.

Current main-bank coverage is 9,803 candidates; 1,949 records remain without
candidates, including 1,018 containing Japanese static text. The reference
rejection queue contains 1,608 unconfirmed identities, 293 control-signature
