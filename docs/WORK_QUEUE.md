...
that fit the current rules. Its report in `build/seasonal-topics-identity-review/`
still identifies 1,461 without visible same-ID English, 73 requiring fields,
...
`build/seasonal-topics-expression-review/queue.jsonl`, generated by
...
Current main-bank coverage is 9,768 candidates; 1,984 records remain without
candidates, including 1,053 containing Japanese static text. The reference
rejection queue contains 1,632 unconfirmed identities, 293 control-signature
differences, 58 missing-field records, and two expansion overflows. These are
...
The 58 missing-field rejections include remaining catchphrases (`1C`), player
