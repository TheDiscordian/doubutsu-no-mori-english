...
| R05 | Mail, headers, footers, and NPC mail components | active | Verified 164-byte record and 10/96/16 text fields; ten routine reference inventories and eight bank-size audits; representation, full wording, editing, display, delivery, and save/reload remain |
