...
| R04 | NPC and item names | active | 178 six-byte villager names and all native loads pass; 107 item-name candidates occupy 230 ten-byte slots; all 4,547 item-ID cases have passing runs, with one unexplained initial stop retained; 35 item callers inventoried; wider names and unresolved identities remain |
