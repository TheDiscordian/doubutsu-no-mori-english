...
that fit the current rules. Its report in `build/native-travel-identity-review/`
identifies 866 without visible same-ID English, two requiring fields,
twelve with control differences, four overflows, 36 native non-static records,
...
`build/native-travel-expression-review/queue.jsonl`, generated by
...
Current main-bank coverage is 10,696 candidates; 1,056 records remain without
candidates, including 134 containing Japanese static text. The reference
rejection queue contains 931 unconfirmed identities, 100 control-signature
...
| R07 | Remaining message matching | active | Hash-bound identities, complete reference and native-original sequences, 41 unanimous complete-native-record aliases, and 74 separately guarded cross-bank letter references implemented; all 360 exact development-label slots accounted for, including fifteen guarded continuation allocations; 99 complete diagnostic labels covered; 134 Japanese-static-text gaps and broader matching remain |
