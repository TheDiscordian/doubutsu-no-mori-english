...
that fit the current rules. Its report in `build/service-save-identity-review/`
still identifies 1,461 without visible same-ID English, 74 requiring fields,
...
`build/service-save-expression-review/queue.jsonl`, generated by
...
Current main-bank coverage is 9,742 candidates; 2,010 records remain without
candidates, including 1,079 containing Japanese static text. The reference
rejection queue contains 1,634 unconfirmed identities, 306 control-signature
