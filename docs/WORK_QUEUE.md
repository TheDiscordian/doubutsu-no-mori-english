...
that fit the current rules. Its report in `build/contextual-choices-identity-review/`
still identifies 1,128 without visible same-ID English, ten requiring fields,
...
`build/contextual-choices-expression-review/queue.jsonl`, generated by
...
Current main-bank coverage is 10,412 candidates; 1,340 records remain without
candidates, including 418 containing Japanese static text. The reference
rejection queue contains 1,204 unconfirmed identities, 111 control-signature
...
| R07 | Remaining message matching | active | Hash-bound identities, complete sequences, 41 unanimous complete-native-record aliases, and 74 separately guarded cross-bank letter references implemented; all 360 exact development labels covered without reusing sequence slots; 418 Japanese-static-text gaps and broader matching remain |
