...
that fit the current rules. Its report in `build/long-advice-identity-review/`
still identifies 1,461 without visible same-ID English, 102 requiring fields,
36 with control differences, seven overflows, 36 native non-static records,
...
Continue the fourteen comparisons in
`build/long-advice-expression-review/queue.jsonl`, generated by
`tools/resident_review_queue.py` from the current candidate file: Rover `0467`,
Gracie `0723`, Booker `0785`, Redd `0789`, Jingle `07AA`, Phyllis `08B0/08B2`,
...
Current main-bank coverage is 9,695 candidates; 2,057 records remain without
candidates, including 1,126 containing Japanese static text. The reference
rejection queue contains 1,667 unconfirmed identities, 320 control-signature
differences, 69 missing-field records, and two expansion overflows. These are
