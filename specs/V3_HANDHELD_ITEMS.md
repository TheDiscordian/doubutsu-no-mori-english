...
pickup/put-away tails and the active-player completion query. The exchange stage
connects normal-drop, empty-hand, buried-item, and fish/insect release endings.
Next connect event actors, acquisition conditions, and the separate balloon
release actor/continuation behaviour.
